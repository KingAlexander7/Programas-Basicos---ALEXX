...
int main()
{
     int m,opcion;	
        ...
        cout << "17. Repartir Pizzas" << endl;
        cout << "18. Calcular El Area de un Cuadrado" << endl;
        cout << "19. Mostrar multiplos de 5 hasta 100" << endl;
        cout << "20. Calcular el area de un rectangulo" << endl;
        cout << "21. SALIR" << endl;
        cout << "<<--INGRESE ALGUNA DE LOS SIGUIENTES ENUNCIADOS-->>"<< endl; 
        cin>>m;
     switch(m)
     {
   ...
   case 10:cout<<">>Crear de forma grafica la multiplicacion manual<<"<<endl;
    ...
    case 17:cout<<">>Repartir 10 Pizzas a 2 grupos de 10 personas<<"<<endl;
     {
     float num1 = 5;
     float num2 = 4; 
     while (num2 != 4) {
     ...
     std::cout << "El Numero de pizzas repartidas a cada grupo son: " << num1 << " y " << num2 << " Pedazos de pizza para cada integrante del grupo: " << std::endl;
     return 0;
	 }
	 
    case 18:cout<<">>Calcular El Area de un Cuadrado de 12cm<<"<<endl;
     {
     float base = 12.0;
     float altura = 12.0;
     float area = (base * altura);
     std::cout << "El area del un cuadrado es: " << area << std::endl;
     return 0;
	 }
	 
	case 19:cout<<">>Mostrar multiplos de 5 hasta 100<<"<<endl;
	 {
     float i = 0.0;
     while (i <= 100.0) {
        if (fmod(i, 5.0) == 0.0) {
    ...
    case 20:cout<<">>Calcular el area de un rectangulo de<<"<<endl;
     {
     float base = 15.0;
     float altura = 7.0;
     float area = (base * altura);
    ...
    case 21:cout<<"SALIDA"<<endl;
     cout<<"NINGUN PROGRAMA QUE IDENTIFICAR"<<endl;{
  	 return 0;
	 }
     default: cout<<" ESTE VALOR NO EXISTE "<<endl;
